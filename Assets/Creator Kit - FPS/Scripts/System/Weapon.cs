...
public class Weapon : MonoBehaviour
{
    ...
    // kpj: a hack so that we can pass on the weapon type
    SoundType GetSoundType()
    {
        switch(triggerType)
        {
            case TriggerType.Auto:
                return SoundType.Automatic;
            default:
                switch(weaponType)
                {
                    case WeaponType.Raycast:
                        return SoundType.Pistol;
                }
                break;
        }
    ...
    public void Fire()
    {
        ...
        // need to tell it what to fire
        FMODKPJ.Fire(GetSoundType(), GetComponent<Transform>().position);
    ...
    public void Reload()
    {
        ...
        // need to tell it what to reload, i.e. which weapon
        FMODKPJ.Reload(GetSoundType(), GetComponent<Transform>().position);
